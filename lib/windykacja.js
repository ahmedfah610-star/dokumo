...
// Tabela stawek. `od` włącznie, obowiązuje do początku następnego wpisu.
// Źródło: obwieszczenia Ministra Rozwoju i Technologii / stopy NBP.
export const STAWKI = {
  // Transakcje handlowe — podmioty niepubliczne (NBP + 10 p.p.)
  handlowe: [
...
export const STAWKI_AKTUALNE_NA = '2026-07-01';
